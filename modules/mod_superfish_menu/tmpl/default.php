...
<script>
	...
	jQuery(function($){
		...
		if (file_exists('templates/'.$template.'/js/jquery-scrolltofixed-min.js')) {
		$document->addScript('templates/'.$template.'/js/jquery-scrolltofixed-min.js');
		}
		else {
		$document->addScript('templates/'.$template.'/js/jquery-scrolltofixed-min.js');
		$document->addScript('modules/mod_superfish_menu/js/jquery-scrolltofixed-min.js');
		}
 		?>
		...
		<?php endif; ?>
		<?php elseif($params->get('enableStickyMobile')) :
		if (file_exists('templates/'.$template.'/js/jquery-scrolltofixed-min.js')) {
		$document->addScript('templates/'.$template.'/js/jquery-scrolltofixed-min.js');
		}
		else {
